...
import static tn.esprit.pidev.entities.Enumeration.Role.ADMIN;
import static tn.esprit.pidev.entities.Enumeration.Role.ETUDIANT;
...
import tn.esprit.pidev.Security.Jwt.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers("/api/v1/auth/**")
                                ...
                                .requestMatchers("/user/**").hasAnyRole(ADMIN.name(),ETUDIANT.name())
